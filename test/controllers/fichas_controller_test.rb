...
class FichasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ficha" do
    assert_difference('Ficha.count') do
      post fichas_url, params: { ficha: { edad: @ficha.edad, nombre: @ficha.nombre, peso: @ficha.peso } }
    end
  ...
  test "should update ficha" do
    patch ficha_url(@ficha), params: { ficha: { edad: @ficha.edad, nombre: @ficha.nombre, peso: @ficha.peso } }
